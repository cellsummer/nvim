...
require('lazy').setup({
  ...
  -- LSP Plugins (disabled — using coc.nvim instead)
  {
  ...
  { -- Autoformat (disabled — coc.nvim handles formatting via :Format)
  ...
  { -- Autocompletion (disabled — using coc.nvim instead)
    'saghen/blink.cmp',
    enabled = false,
    event = 'VimEnter',
    version = '1.*',
    ...
    config = function()
      ...
      miniclue.setup {
        ...
        clues = {
          ...
          { mode = 'n', keys = '<Leader>c', desc = '+[C]oc' },
          ...
          { mode = 'n', keys = '<Leader>a', desc = '+Code [A]ction' },
          { mode = 'n', keys = '<Leader>r', desc = '+[R]efactor' },
          { mode = 'n', keys = '<Leader>s', desc = '+[S]earch' },
          { mode = 'v', keys = '<Leader>s', desc = '+[S]earch' },
          { mode = 'n', keys = '<Leader>t', desc = '+[T]ab' },
          { mode = 'n', keys = '<Leader>u', desc = '+[U]I Toggle' },
          { mode = 'n', keys = 'gr', desc = '+LSP [R]eferences' },
